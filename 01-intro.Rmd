...
### RStudio interface
You should be able to see 3 or 4 panes in the layout. There are:
...
To start using R, you need to open up an R script. In RStudio, click **File > New File > R Script**, or click on the icon ![](img/plus.png)\ and choose **R Script** from the dropdown menu. You may also type the shortcut **Ctrl+Shift+N**. You should be able to get RStudio interface similar to Figure 1.2 before (four panes view).
...
### Functions
R commands are in the form of `function()`. If you are familiar with MS Excel, think of MS Excel function. Inside a function, there will be a number of arguments. For each argument, you may need to provide the parameter. We will see this as we go through the examples later.
